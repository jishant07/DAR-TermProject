...
Here we will try to peg everything against the G3 value to understand performance factors. All factors against the marks to understand direct effect on marks.  
In between we will also try to understand if one type column has significant dependence on the other to understand the whole piture.
...
```{r}
  ...
  get_summary_stats(gender.groupings)
